(function () {
  ...
  addMsg("EmiCode ready. Describe a coding task or ask about EmiOS's internals — your request goes to Claude Code (locally via your Max subscription) with curated context (CLAUDE.md + matched architecture docs). Read-only — Claude can read the repo but not edit.", "system");
})();
