# File: assistant/lib/tools/kg_team_manager/kg_team_manager.py

from app.assistant.lib.core_tools.base_tool.base_tool import BaseTool
from app.assistant.lib.core_tools.manager_interface.manager_interface import ManagerInterface

class kg_team_manager(BaseTool):
    def __init__(self):
        super().__init__('kg_team_manager')
        self.manager_interface = ManagerInterface('kg_team_manager')
