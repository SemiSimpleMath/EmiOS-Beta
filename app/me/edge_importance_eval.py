"""Eval harness for me::edge_importance_rater.
...
Usage:
    python -m app.me.edge_importance_eval
    python -m app.me.edge_importance_eval --few-shot 5    # use 5 cases as
                                                          # in-prompt examples
                                                          # and eval on the rest

The few-shot mode lets you split the cases: first N go into the system
prompt as worked examples (showing the model what good looks like),
...
from app.me.edge_importance import _build_edge_block
